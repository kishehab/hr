...
var BoardComponent = /** @class */ (function () {
    function BoardComponent(dialog, _TileServiceService) {
        this.dialog = dialog;
    ...
    BoardComponent.prototype.INITIATE_TILES_MANAGER = function () {
        // check if if the tiles array has not element
    };
    BoardComponent.prototype.incrementCols = function (element) {
        // identify the ID
    ...
    BoardComponent.prototype.decrementCols = function (element) {
        // identify the ID
        var index = this.findTileIndexByID(element.id);
        var currentCols;
        // check if the index is found
    ...
    BoardComponent.prototype.incrementRows = function (element) {
        // identify the ID
        var index = this.findTileIndexByID(element.id);
        var currentRows;
        // check if the index is found
    ...
    BoardComponent.prototype.decrementRows = function (element) {
        // identify the ID
        var index = this.findTileIndexByID(element.id);
        var currentRows;
        // check if the index is found
    ...
    BoardComponent.prototype.addDefaultTile = function () {
        this.tiles.push({
    ...
    BoardComponent.prototype.addTile = function (cols, rows, text, color) {
        this.tiles.push({
            id: this.id_generator++,
            cols: cols,
            rows: rows,
    ...
    BoardComponent.prototype.deleteTile = function (element) {
        // identify the ID
        var index = this.findTileIndexByID(element.id);
        if (index >= 0) {
    ...
    BoardComponent.prototype.findTileIndexByID = function (id) {
        var index = -1;
    ...
    BoardComponent.prototype.clearAllTiles = function () {
        var _this = this;
        // open dialog to make sure user want to clear all tile
        var userInput = this.dialog.open(_clear_all_dialog_clear_all_dialog_component__WEBPACK_IMPORTED_MODULE_3__["ClearAllDialogComponent"]);
        userInput.afterClosed().subscribe(function (result) {
            // check if the array is not empty.
            console.log(_this.tiles.length > 0 && result);
            if (_this.tiles.length > 0 && result === "true") {
                console.log("get in!");
                _this.tiles = [];
                // reset the tileCount
                _this.tilesCount = 0;
...
var ButtonWidgetComponent = /** @class */ (function () {
    function ButtonWidgetComponent(_ToolbarServiceService) {
    ...
    ButtonWidgetComponent.prototype.ngOnInit = function () {
    };
    ButtonWidgetComponent.prototype.EmitClickEvent = function (widgetTemplateRef) {
        this.widgetClick.emit(widgetTemplateRef);
    };
    ButtonWidgetComponent.prototype.close = function () {
        this._ToolbarServiceService.close();
    };
    ButtonWidgetComponent.prototype.drop = function (event) {
        alert("dropped!");
        console.log("dropped!");
    };
...
var ClearAllDialogComponent = /** @class */ (function () {
    function ClearAllDialogComponent() {
    }
    ClearAllDialogComponent.prototype.ngOnInit = function () {
    };
    ...
    return ClearAllDialogComponent;
}());
...
var LayoutGridComponent = /** @class */ (function () {
    function LayoutGridComponent(_TileServiceService) {
        this._TileServiceService = _TileServiceService;
    ...
    LayoutGridComponent.prototype.requestBoardToAddTile = function () {
        console.log("rbtt");
        this.isRequested = true;
    };
    LayoutGridComponent.prototype.openSidenav = function (msg) {
...
var ProfileComponent = /** @class */ (function () {
    function ProfileComponent(_snackBar) {
    ...
    ProfileComponent.prototype.editModde = function () {
        this.isDisabled = false;
        this.btnHandleEdit = false;
    };
    ProfileComponent.prototype.saveEditedForm = function () {
        this._snackBar.open('saved', 'dismise');
        this.isDisabled = true;
        this.btnHandleEdit = true;
    };
    ProfileComponent.prototype.cancelEditForm = function () {
        this.isDisabled = true;
        this.btnHandleEdit = true;
    };
...
var RegisterationComponent = /** @class */ (function () {
    function RegisterationComponent(formBuilder) {
    ...
    RegisterationComponent.prototype.onSubmit = function () {
        console.warn(this.profileForm.value);
    };
    RegisterationComponent.ctorParameters = function () { return [
...
var SideNavigationComponent = /** @class */ (function () {
    function SideNavigationComponent(_ToolbarServiceService) {
        this._ToolbarServiceService = _ToolbarServiceService;
    }
...
var TestGroundComponent = /** @class */ (function () {
    function TestGroundComponent() {
    }
    TestGroundComponent.prototype.ngOnInit = function () {
    };
...
var TileServiceService = /** @class */ (function () {
    function TileServiceService() {
        this.number = ['1', '2', '3'];
    }
    TileServiceService.prototype.getNumber = function () {
        return this.number;
    };
...
var ToolbarServiceService = /** @class */ (function () {
    function ToolbarServiceService() {
    }
    // assign passing navside to this panel
    ToolbarServiceService.prototype.setPanel = function (sidenav) {
        this.panel = sidenav;
    };
    // assign the refrence to ng-template
    ToolbarServiceService.prototype.setContentVcf = function (viewContainerRef) {
        this.vcf = viewContainerRef;
    };
    // create view from the refrence of ng-template
    ToolbarServiceService.prototype.createView = function (template) {
        this.vcf.clear();
        this.vcf.createEmbeddedView(template);
    };
    // create a view and then assign it to naveside and then open 
    ToolbarServiceService.prototype.open = function (template) {
        this.createView(template);
        return this.panel.open();
    };
    // close the panel 
    ToolbarServiceService.prototype.close = function () {
        this.panel.close();
    };
    // toggle the panel
    ToolbarServiceService.prototype.toggle = function () {
...
var ToolbarComponent = /** @class */ (function () {
    function ToolbarComponent(_ToolbarServiceService) {
        this._ToolbarServiceService = _ToolbarServiceService;
    }
    ToolbarComponent.prototype.ngOnInit = function () {
    };
    ToolbarComponent.prototype.openWidget = function ($event) {
        this._ToolbarServiceService.open($event);
    };
    ToolbarComponent.prototype.closeWidget = function () {
        this._ToolbarServiceService.close();
    };
